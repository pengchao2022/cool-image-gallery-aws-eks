...
# Community Service ECR Repository
resource "aws_ecr_repository" "community" {
  name                 = "${var.project_name}-${var.environment}-community"
  image_tag_mutability = var.image_tag_mutability
...
# Community Repository Lifecycle Policy
resource "aws_ecr_lifecycle_policy" "community" {
  repository = aws_ecr_repository.community.name
...
resource "aws_ecr_repository_policy" "community" {
  repository = aws_ecr_repository.community.name
